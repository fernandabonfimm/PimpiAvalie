...
const {createAdmin, loginAdmin, getIdById} = require('../controllers/admin.controller');
const {createB2B, getAllB2B, getB2BById} = require('../controllers/b2b.controller');
const {createCategoria, getAllCategoria, getCategoriaById} = require('../controllers/categoria.controller');
const {createProduto, getAllProduto, getProdutoById} = require('../controllers/produto.controller');
const {createStep1, updateStep2, getAllAvaliacao, getAvaliacaoById} = require('../controllers/avaliacao.controller');
// Admin routes
